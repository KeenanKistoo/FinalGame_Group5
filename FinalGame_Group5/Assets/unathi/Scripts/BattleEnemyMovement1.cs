...
{
    public class BattleEnemyMovement : MonoBehaviour
    {
        Transform player;
        ...
        private void FindNearestTarget()
        {
            ...
            {
                case 1:
                    foreach (Transform target in levelManager.hidingSpots_b1)
                    {
                        if (levelManager.hidingSpots_b1 == null)
                        {
                            //Debug.Log("Fuck");
                        }
                    ...
                    break;
                case 2:
                    foreach (Transform target in levelManager.hidingSpots_b2)
                    {
                    ...
                    break;
                case 3:
                    foreach (Transform target in levelManager.hidingSpots_b3)
                    {
                        if (levelManager.hidingSpots == null)
                        {
                            //Debug.Log("Fuck");
